...
class WebSearchTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Универсальный поиск информации в интернете. "
            "Используй для: новостей, фактов, цен товаров, биографий, "
            "событий, расписаний, обзоров, и любых вопросов, на которые "
            "не отвечают другие инструменты. "
            "Также подходит для курсов валют как запасной вариант, "
            "если get_currency_rate недоступен. "
            "Если ты сомневаешься, какой инструмент использовать — выбирай этот."
        )
